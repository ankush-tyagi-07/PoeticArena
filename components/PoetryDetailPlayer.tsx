...
const PoetryDetailPlayer = ({
  ...
  const handleDelete = async () => {
    try {
      await deletePoetry({ poetryId, imageStorageId, audioStorageId });
      toast({
        title: "Poetry deleted",
      });
      router.push("/");
    } catch (error) {
      console.error("Error deleting poetry", error);
      toast({
        title: "Error deleting poetry",
        variant: "destructive",
      });
    }
  };
...
export default PoetryDetailPlayer;